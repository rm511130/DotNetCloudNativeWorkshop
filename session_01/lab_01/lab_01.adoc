...
. Download and clone the git repo in Visual Studio, if you have the command line tool installed, or you can click 'Download ZIP' on the right side of the page [here](https://github.com/Pivotal-Field-Engineering/pcf-dotnet-environment-viewer){:target="_blank"}
+
----
